...
#' \deqn{\begin{matrix}
#'   P(\sigma_v|v_{0:N},y_{1:N},J_{1:N},I_{1:N})
...
#' where
#' \deqn{\sqrt{v_{n-1}h}\epsilon_n^y=y_n-\mu h+\frac{1}{2}v_{n-1}h - J_nI_n.}
...
#' rsigma_v(sigma_v_old,prior_shape,prior_rate,v,y,jsize,jtime,mu,k,theta,rho,h)
rsigma_v <- function(sigma_v_old,prior_shape,prior_rate,v,y,jsize,jtime,mu,k,theta,rho,h) {
  # check extreme case
